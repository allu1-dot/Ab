...
| Placement mock B3 | `9431704e-cfff-4754-b6ae-3e7e55028c92` | nano_banana_pro→nb2 · 2K · 9:16 · B2 as ref; walkway, starting blocks, machine correction pass 1, mezzanine gym visible | 2 cr | Superseded by B4 |
| Placement mock B4 (anchor candidate) | `ba190f90-22b6-4222-8c02-c796ba5a2790` | nano_banana_pro→nb2 · 2K · 9:16 · B3 as ref; founder re-attached the J8 elevation in chat, exposing a standing description error: header wordmark is NAVY serif with a gold swash (not gold) — machine front redrawn to the elevation in full (header layout, 4×6 lanes with navy rail plates, right panel screen/keypad/contactless stack, PUSH tray, PICK UP edge lettering) and the missing starting block added on the lane behind the machine | 2 cr | Completed, awaiting founder eye |
